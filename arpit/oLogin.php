...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM `owner` where ownername='$username' AND pass= '$password' and mobile ='$mobileNo'";
...
?>
    ...
    <div class="container">
        <h2 class="text-center my-4">Owner Login Pannel</h2>
        <form action="/arpit/oLogin.php" method="post">
